...
void fillMap (std::string configFilePath, bool daemonInput);
...
// the values found here are passed to the fillMap method
...
void parser (int argc, char * argv []){
		...
		fillMap ( configFilePath, daemonInput);
...
void fillMap (std::string configFilePath, bool daemonInput){
	...
	// add the config file path to the map, as a c style string
